...
import { C, MACRO, STATE } from './config.js';
...
export function getFont(r){
  const m={
    spec:{display:'Bricolage Grotesque',body:'IBM Plex Sans',mono:'JetBrains Mono'},
    editorial:{display:'Fraunces',body:'Inter',mono:'JetBrains Mono'},
    swiss:{display:'Space Grotesk',body:'IBM Plex Sans',mono:'Space Mono'},
    brutalist:{display:'Clash Display',body:'Satoshi',mono:'JetBrains Mono'},
    contrast:{display:'Instrument Serif',body:'Plus Jakarta Sans',mono:'JetBrains Mono'}
  };
  return(m[STATE.font]||m.spec)[r];
}
